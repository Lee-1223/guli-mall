...
import com.ljl.gulimall.coupon.entity.CouponSpuCategoryRelationEntity;
import com.ljl.gulimall.coupon.service.CouponSpuCategoryRelationService;
...
public class CouponSpuCategoryRelationController {
     ...
     */
    @RequestMapping("/list")
    // @RequiresPermissions("coupon:couponspucategoryrelation:list")  // 修改controller模版，不使用shiro
