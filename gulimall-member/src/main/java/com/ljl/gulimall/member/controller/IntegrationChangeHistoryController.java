...
import com.ljl.gulimall.member.service.IntegrationChangeHistoryService;
...
public class IntegrationChangeHistoryController {
     ...
     */
    @RequestMapping("/list")
    // @RequiresPermissions("member:integrationchangehistory:list")  // 修改controller模版，不使用shiro
