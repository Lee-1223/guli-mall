package com.ljl.gulimall.order.controller;
...
import com.ljl.gulimall.order.service.OrderOperateHistoryService;
...
public class OrderOperateHistoryController {
     ...
     */
    @RequestMapping("/list")
    // @RequiresPermissions("order:orderoperatehistory:list")  // 修改controller模版，不使用shiro
